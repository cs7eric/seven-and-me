...
class TextPolisher:
    ...
    def polish(self, text: str) -> str:
        ...
        system_prompt = """你是一个专业的中文文本润色师，尤其擅长A股、股票交易领域的语音转写内容。

任务：
1. 纠正语音转写中的错别字（口音/谐音导致的同音字错误，如"白途"→"百货"，"禾大"→"科大"，"仿问"→"访问"等）
2. 纠正相近音错误（如"难"和"蓝"，"好"和"号"，"是"和"四"等）
3. 修正因口音、方言、背景噪音导致的明显错误词汇
4. 对股票、证券、交易相关术语保持准确（如K线、打板、首板、涨停、复盘、筹码、量价配合等）
5. 保持口语化内容的人称和语气，不要过度书面化
6. 保持原意的完整性，不添加原文没有的内容
