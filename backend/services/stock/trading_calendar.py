...
HOLIDAYS: dict[date, str] = {
    ...
    date(2024, 2, 15): "春节",
    date(2024, 2, 16): "春节",
    date(2024, 2, 17): "春节调休",  # 周六, 国务院通知为工作日但 A 股实际休市
    date(2024, 2, 18): "春节调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2024, 4, 4): "清明",
    date(2024, 4, 5): "清明",
    date(2024, 4, 6): "清明",
    date(2024, 4, 28): "劳动节调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2024, 5, 1): "劳动节",
    date(2024, 5, 2): "劳动节",
    date(2024, 5, 3): "劳动节",
    date(2024, 5, 5): "劳动节调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2024, 6, 10): "端午",
    date(2024, 9, 15): "中秋",
    date(2024, 9, 16): "中秋",
    date(2024, 9, 17): "中秋",
    date(2024, 9, 29): "国庆调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2024, 10, 1): "国庆",
    date(2024, 10, 2): "国庆",
    date(2024, 10, 3): "国庆",
    date(2024, 10, 4): "国庆",
    ...
    date(2024, 10, 6): "国庆",
    date(2024, 10, 7): "国庆",
    date(2024, 10, 12): "国庆调休",  # 周六, 国务院通知为工作日但 A 股实际休市
    # ---- 2025 ----
    date(2025, 1, 1): "元旦",
    date(2025, 1, 26): "春节调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2025, 1, 28): "春节",
    date(2025, 1, 29): "春节",
    date(2025, 1, 30): "春节",
    date(2025, 1, 31): "春节",
    date(2025, 2, 3): "春节",
    date(2025, 2, 4): "春节",
    date(2025, 2, 8): "春节调休",  # 周六, 国务院通知为工作日但 A 股实际休市
    date(2025, 4, 4): "清明",
    date(2025, 4, 5): "清明",
    date(2025, 4, 6): "清明",
    date(2025, 4, 27): "劳动节调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2025, 5, 1): "劳动节",
    date(2025, 5, 2): "劳动节",
    date(2025, 5, 5): "劳动节",
    date(2025, 5, 31): "端午",
    date(2025, 6, 2): "端午",
    date(2025, 9, 28): "国庆调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2025, 10, 1): "国庆",
    date(2025, 10, 2): "国庆",
    date(2025, 10, 3): "国庆",
    date(2025, 10, 6): "国庆",
    date(2025, 10, 7): "国庆",
    date(2025, 10, 8): "国庆",
    date(2025, 10, 11): "国庆调休",  # 周六, 国务院通知为工作日但 A 股实际休市
    # ---- 2026 ----
    date(2026, 1, 1): "元旦",
    date(2026, 1, 2): "元旦",
    date(2026, 1, 4): "元旦调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2026, 2, 14): "春节调休",  # 周六, 国务院通知为工作日但 A 股实际休市
    date(2026, 2, 16): "春节",
    date(2026, 2, 17): "春节",
    date(2026, 2, 18): "春节",
    date(2026, 2, 19): "春节",
    ...
    date(2026, 2, 23): "春节",
    date(2026, 2, 24): "春节",
    date(2026, 2, 28): "春节调休",  # 周六, 国务院通知为工作日但 A 股实际休市
    date(2026, 4, 6): "清明",
    date(2026, 5, 1): "劳动节",
    date(2026, 5, 4): "劳动节",
    date(2026, 5, 5): "劳动节",
    date(2026, 5, 9): "劳动节调休",  # 周六, 国务院通知为工作日但 A 股实际休市
    date(2026, 6, 19): "端午",
    date(2026, 9, 25): "中秋",
    date(2026, 9, 27): "中秋调休",  # 周日, 国务院通知为工作日但 A 股实际休市
    date(2026, 10, 1): "国庆",
    date(2026, 10, 2): "国庆",
    date(2026, 10, 5): "国庆",
    date(2026, 10, 6): "国庆",
    date(2026, 10, 7): "国庆",
    date(2026, 10, 10): "国庆调休",  # 周六, 国务院通知为工作日但 A 股实际休市
    # ---- 2027 (预估, 国务院未发时按规则推断) ----
    date(2027, 1, 1): "元旦",
}

# 周末调休补班日 (周末但实际是交易日).
# 维护原则: A 股自 2008 年起几乎从不在调休补班日开市 (跟国务院放假通知脱钩).
# 用 sh000001 真实数据反推校验, 标错一个就照成 HOLIDAYS, 不要进 WORKDAYS_OVERTIME.
WORKDAYS_OVERTIME: set[date] = set()
