    ...
    try:
        ...
        if r.returncode == 0:
            ...
            if not valid:
                ...
                logger.info("sector_breadth ok in %.1fs: upserted=%s", elapsed, status.get("lastRowsUpserted"))
        else:
